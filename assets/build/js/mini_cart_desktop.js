...
if (tws__mini_cart_ul) {
  ...
  function decrement_quantity(product_id) {
    ...
    // Remove the product if qty 1 and click agin the decrement button
      ...
      document.getElementById("tws__mini_cart_remove_".concat(product_id)).click();
    }
        ...
        if (tws__cart_loop_counter_) {
          ...
          document.getElementById("tws__cart_loop_decrement_".concat(currentChild.dataset.product_id)).addEventListener('click', function (e) {
            ...
            // Remove the product if qty 1 and click agin the decrement button
              ...
              document.getElementById("tws__mini_cart_remove_".concat(currentChild.dataset.product_id)).click();
            }
          }); // Decrement button in Loop Proudct
        ...
        if (tws__cart_hover_loop_decrement_) {
          tws__cart_hover_loop_decrement_.addEventListener('click', function (e) {
            ...
            // Remove the product if qty 1 and click agin the decrement button
              ...
              document.getElementById("tws__mini_cart_remove_".concat(currentChild.dataset.product_id)).click(); // remove
            }
...
/******/ })()
;
//# sourceMappingURL=mini_cart_desktop.js.map