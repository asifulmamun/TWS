...
function update_static_data(data) {
  ...
  var tws__top_search = document.getElementById('tws__top_search');
  if (tws__top_search) {
    tws__top_search.placeholder = data.tws__top_search;
  }

  // Update Footer Live Chat Text
  var tws__live_support = document.getElementById('tws__live_support');
...
xmlhttp.onload = function () {
  if (xmlhttp.status === 200) {
    ...
    var xmlhttpSample = new XMLHttpRequest();
...
"use strict";
/*!*******************************!*\
  !*** ./src/js/app_desktop.js ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sass_app_desktop_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../sass/app_desktop.scss */ "./src/sass/app_desktop.scss");
...
console.log('this is app_desktop.js');
...
/******/ })()
;
//# sourceMappingURL=app_desktop.js.map