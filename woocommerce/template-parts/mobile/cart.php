						...
						<td class="product-remove">
							<?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a class="py-2 px-3 bg-red-500 text-white font-bold" href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">Remove</a>',
...
<?php
	...
	wp_enqueue_script( 'woo_single_product', get_template_directory_uri() . '/assets/build/js/mobile_cart_checkout.js', array(), null, true);   
