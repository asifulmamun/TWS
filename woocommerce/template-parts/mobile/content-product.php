...
?>
<li <?php wc_product_class( 'tws__product_wrapper group relative grid justify-items-center overflow-hidden p-1 hover:shadow-lg', $product ); ?>>
	...
	<div class="pt-3"><?php woocommerce_template_loop_product_title(); /* Product Title Title */ ?></div>
	<div class=""><?php do_action('woocommerce_after_shop_loop_item_title'); /* Price */ ?></div>
