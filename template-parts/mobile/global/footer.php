<footer class="fixed bottom-0 right-0 w-full overflow-hidden">
    <div class="grid grid-cols-5 gap-1">
        <a class="w-full py-2" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>&orders">
        ...
        <a class="w-full py-2" href="<?php echo esc_url(home_url('/')); ?>?s=">
            <svg class="w-6 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
            </svg>
        </a>
        <a class="w-full py-2" href="<?php echo esc_url(home_url('/')); ?>">
            <svg class="w-6 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a class="w-full py-2" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
            <svg class="w-6 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
