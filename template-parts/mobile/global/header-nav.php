<header id="tws__header" class="grid grid-cols-10 py-0.5">
    <div class="col-span-8 px-3">
        <div class="tws__search_box group relative rounded-md overflow-hidden">
            ...
            ?></div>
            <form action="">
                <input id="search" name="s" type="search" class="w-full block pl-20 group-hover:pl-4 pr-10 py-2 rounded outline-none transition-all ease-in-out delay-150 duration-300" placeholder="সার্চ করুন (স্কুল ব্যাগ, বড় ব্যাগ)" />
